...
export const translations = {
  ja: {
    ...
    'download.cardPending': '最新版を確認中...',
    'download.cardCta': 'ダウンロード',
    'download.latestRelease': '最新リリース',
    'download.releaseFallback': 'GitHub Releasesから取得',
    'download.primaryDownloads': '主要ダウンロード',
    'download.primaryDownloadsDesc': 'Windows / macOS インストーラー合計',
    'download.releaseNotes': 'リリースノート',
    'download.releaseNotesCta': '変更点と既知の問題を見る',
    'download.releaseNotesDesc': '不安な場合は先にリリース内容を確認できます',
    'download.historyTitle': 'ダウンロード推移',
    'download.historyDescription': 'GitHub Releasesのダウンロード履歴を毎日更新しています。',
    'download.historyAlt': 'AITuberFlowのダウンロード推移グラフ',
    // Download page
  ...
  en: {
    ...
    'download.cardPending': 'Checking latest release...',
    'download.cardCta': 'Download',
    'download.latestRelease': 'Latest release',
    'download.releaseFallback': 'Fetched from GitHub Releases',
    'download.primaryDownloads': 'Primary downloads',
    'download.primaryDownloadsDesc': 'Windows / macOS installer total',
    'download.releaseNotes': 'Release notes',
    'download.releaseNotesCta': 'View changes and known issues',
    'download.releaseNotesDesc': 'Check the release details before installing if needed',
    'download.historyTitle': 'Download history',
    'download.historyDescription': 'GitHub Releases download trends are updated daily.',
    'download.historyAlt': 'AITuberFlow download trend chart',
    // Download page
